...
const { GOOGLE_AUTH_CLIENTID, GOOGLE_AUTH_SECRET, JWT_SECRET, JWT_ACCESS_EXPIRY, JWT_REFRESH_SECRET, JWT_REFRESH_EXPIRY, } = process.env;
const store = new user_1.User();
const oAuth2Client = new google_auth_library_1.OAuth2Client(GOOGLE_AUTH_CLIENTID, GOOGLE_AUTH_SECRET, 'postmessage');
const googleAuth = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!user) {
            ...
            user = yield store.googleAuthRegister(payload.email, `${payload.given_name} ${payload.family_name}${randomNumber}`);
        }
