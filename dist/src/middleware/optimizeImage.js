...
const optimizeImage = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const path = `${folder}/${(0, uuid_1.v4)()} - ${(_a = req.file) === null || _a === void 0 ? void 0 : _a.originalname}`;
    try {
        yield (0, sharp_1.default)((_b = req.file) === null || _b === void 0 ? void 0 : _b.buffer).resize(600, 400).toFile(path);
